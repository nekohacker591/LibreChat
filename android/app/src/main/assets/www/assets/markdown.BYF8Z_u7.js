import{r as e}from"./query-devtools.DIz6FZCX.js";import{h as t}from"./tanstack-vendor.C7oK5bXW.js";import{Mm as n,Nm as r,Ph as i,Xh as a,yg as o}from"./hooks.CchoAWPN.js";var s=n=>{let r=e(),{onSuccess:s,onError:c,onMutate:l,...u}=n??{},d={mutationFn:e=>o.editArtifact(e),onMutate:async e=>(l&&await l(e),{previousMessages:{},updatedConversationId:null}),onError:(e,t,n)=>{c?.(e,t,n)},onSuccess:(e,t,n)=>{let o=!0,c=n=>{n&&r.setQueryData([a.messages,n],n=>{if(!n)return n;let r=[...n],i;for(let e=r.length-1;e>=0;e--)if(r[e].messageId===t.messageId){i=e,o=!1;break}return i==null?n:(r[i]={...r[i],content:e.content,text:e.text},r)})};c(e.conversationId),o&&(console.warn("Edited Artifact Message not found in cache, trying `new` as `conversationId`"),c(i.NEW_CONVO)),s?.(e,t,n)},...u};return t(d)},c=(n,r)=>{let i=e(),{onSuccess:s,onError:c,onMutate:l,...u}=r??{},d={mutationFn:e=>o.branchMessage(e),onMutate:async e=>(l&&await l(e),n&&await i.cancelQueries([a.messages,n]),{previousMessages:n?i.getQueryData([a.messages,n]):void 0,conversationId:n}),onError:(e,t,n)=>{n?.conversationId&&n?.previousMessages&&i.setQueryData([a.messages,n.conversationId],n.previousMessages),c?.(e,t,n)},onSuccess:(e,t,n)=>{let r=e.conversationId||n?.conversationId;r&&i.setQueryData([a.messages,r],t=>t?[...t,e]:[e]),s?.(e,t,n)},...u};return t(d)},l=new Set([`http:`,`https:`,`mailto:`,`tel:`]),u=e=>{let t=e.trim();if(!t)return!1;if(t.startsWith(`/`)||t.startsWith(`#`)||t.startsWith(`.`))return!0;try{return l.has(new URL(t).protocol)}catch{return!1}},d=`
...
};`;function g(e){let t=e?n:r,i=(e,n)=>{let r=t[e]?.trim().split(/\s+/).map(Number);return r?.length!==3||r.some(Number.isNaN)?n:`#${r.map(e=>e.toString(16).padStart(2,`0`)).join(``)}`},a=i(`rgb-surface-primary`,e?`#000000`:`#ffffff`),o=i(`rgb-text-primary`,e?`#ffffff`:`#000000`),s=i(`rgb-link`,e?`#8cc8ff`:`#0000cc`),c=i(`rgb-border-medium`,o);return`
...
.markdown-body code, .markdown-body pre { color: ${o}; background-color: ${i(`rgb-surface-secondary`,a)}; }
.markdown-body pre { border: 1px solid ${c}; }
::-webkit-scrollbar-thumb { background-color: ${o}; }
* { scrollbar-color: ${o} ${a}; }
.markdown-error { color: ${i(`rgb-text-destructive`,e?`#ff8f8f`:`#a10000`)}; }
