...
<p align="center">
  <a href="https://github.com/nekohacker591/LibreChat/releases/latest">
    <img src="https://img.shields.io/github/v/release/nekohacker591/LibreChat?color=blue&label=Release%20v1.1.0" alt="Latest Release">
  </a>
...
Download the ready-to-run release files from [**GitHub Releases v1.1.0**](https://github.com/nekohacker591/LibreChat/releases/tag/v1.1.0):

| Artifact | File Name | Size | Target Platform | Description |
| :--- | :--- | :--- | :--- | :--- |
| **Android APK** | [**`LibreChat-v1.1.0-release.apk`**](https://github.com/nekohacker591/LibreChat/releases/download/v1.1.0/LibreChat-v1.1.0-release.apk) | ~12.6 MB | Android 8.0+ | Standalone APK with on-device HTTP server, SQLite, OpenCode Go & Zen, and DevPass integration. |
| **Desktop Installer** | [**`LibreChat-Setup-1.0.5.exe`**](https://github.com/nekohacker591/LibreChat/releases/download/v1.1.0/LibreChat-Setup-1.0.5.exe) | ~79.0 MB | Windows 10 / 11 (x64) | Full desktop installer with embedded MongoDB and background auto-updater. |
| **Desktop Portable** | [**`LibreChat-1.0.5.exe`**](https://github.com/nekohacker591/LibreChat/releases/download/v1.1.0/LibreChat-1.0.5.exe) | ~78.8 MB | Windows 10 / 11 (x64) | Standalone portable executable. Requires no installation. |
| **Update Manifest** | [`latest.yml`](https://github.com/nekohacker591/LibreChat/releases/download/v1.1.0/latest.yml) | 346 B | Auto-Updater | Differential update hash and release manifest. |
...
### Android
1. **Download & Install**: Grab `LibreChat-v1.1.0-release.apk` and install it on your device (tap **Install anyway** if prompted by Play Protect).
